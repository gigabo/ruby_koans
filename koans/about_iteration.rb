...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject iterates over each item in a list, executing the provided
    # block on that item, and an accumulator.  The result is stored in the
    # accumulator, and passed to the block for the next item.
  end
