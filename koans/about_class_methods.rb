...
class AboutClassMethods < EdgeCase::Koan
  ...
  # If I were only defining one or two class methods I might opt for the
  # first, since it's a little bit less obscure seeming.  The second would
  # be nice for defining many class methods, though.
